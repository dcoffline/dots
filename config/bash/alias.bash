...
# ──────  HOST ALIASES ──────
  ...
  alias dea='distrobox enter athena -e cd $HOME'
...
#alias wave="/var/home/eric/Applications/wave.appimage --ozone-platform=x11 --enable-transparent-visuals --ignore-gpu-blocklist"
